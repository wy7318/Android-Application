...
public class CreateNoteBank extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.createlayout_bank);
        ...
        addNoteToDB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (accountid.equals("") || accountpass.equals("")) {
                    Toast.makeText(getApplicationContext(), "You must fill ID and Password", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (!isEdit) {
                    ...
                    Intent intent = new Intent(CreateNoteBank.this, Simple_NotepadActivity.class);
                    // Start next activity
                    startActivity(intent);
                    CreateNoteBank.this.finish();
                } else {
