    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sch_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Introduce.this, Schedule.class);
                // Start next activity
        ...
        rev_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Introduce.this, RevIntro.class);
                // Start next activity
                startActivity(intent);
                Introduce.this.finish();
            }
        ...
        way_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Introduce.this, MapsActivity.class);
                // Start next activity
                startActivity(intent);
                Introduce.this.finish();
            }
        ...
        church_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Introduce.this, Introduce.class);
                // Start next activity
                startActivity(intent);
                Introduce.this.finish();
            }
