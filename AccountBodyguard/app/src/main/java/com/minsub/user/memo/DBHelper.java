...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String KEY_ACNTID = "noteID";
	private static final String KEY_ACNTPAS = "notePassword";
	private static final String KEY_URL = "noteURL";
	private static final String KEY_CONTENT = "noteContent";
	private static final String KEY_DATE = "date";
	//sql query to creating table in database
	private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (id INTEGER PRIMARY KEY AUTOINCREMENT, "+KEY_TITLE+" TEXT NOT NULL, "+KEY_ACNTID+" TEXT NOT NULL, "+KEY_ACNTPAS+" TEXT NOT NULL, "+KEY_URL+" TEXT NOT NULL,"+KEY_CONTENT+" TEXT NOT NULL, "+KEY_DATE+" TEXT);";
	...
	public void addNote(String title, String content, String accountid, String accountpass, String url) {
		...
		cv.put("noteID", accountid);
		cv.put("notePassword", accountpass);
		cv.put("noteURL", url);
	...
	//getting all notes
	public Cursor getNotes(SQLiteDatabase db, int id) {
		//db.query is like normal sql query
		//cursor contains all notes 
		Cursor c = db.query(TABLE_NAME, new String[] {KEY_TITLE, KEY_ACNTID, KEY_ACNTPAS, KEY_URL, KEY_CONTENT, KEY_DATE}, KEY_ID + " = ?", new String[] { String.valueOf(id) }, null, null, null);
	...
	public void updateNote(String title, String content, String accountid, String accountpass, String url, String editTitle) {
		SQLiteDatabase db = this.getWritableDatabase();
